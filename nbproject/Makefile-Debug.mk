...
${OBJECTDIR}/BuyingMedicine.o: BuyingMedicine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BuyingMedicine.o BuyingMedicine.cpp
...
${OBJECTDIR}/Clinic.o: Clinic.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clinic.o Clinic.cpp

${OBJECTDIR}/ClinicReservation.o: ClinicReservation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClinicReservation.o ClinicReservation.cpp
...
${OBJECTDIR}/HospitalReservation.o: HospitalReservation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HospitalReservation.o HospitalReservation.cpp

${OBJECTDIR}/Lab.o: Lab.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lab.o Lab.cpp

${OBJECTDIR}/LabReservation.o: LabReservation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LabReservation.o LabReservation.cpp

${OBJECTDIR}/Major.o: Major.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Major.o Major.cpp

${OBJECTDIR}/MedLinkedList.o: MedLinkedList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MedLinkedList.o MedLinkedList.cpp

${OBJECTDIR}/MedQueue.o: MedQueue.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MedQueue.o MedQueue.cpp

${OBJECTDIR}/MedStack.o: MedStack.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MedStack.o MedStack.cpp

${OBJECTDIR}/Medication.o: Medication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Medication.o Medication.cpp
...
${OBJECTDIR}/filehandling.o: filehandling.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filehandling.o filehandling.cpp
...
${OBJECTDIR}/mainMenu.o: mainMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mainMenu.o mainMenu.cpp
